...
{
    public class BurnBattleBattleStatus : BattleStatusEffect, ITurnStartCallbackReceiver
    {
        private readonly BurnStatusData data;

        private readonly EventInstance? burnSfx;
        
        public BurnBattleBattleStatus(BurnStatusData data, int turns, BattleCharacter character) 
